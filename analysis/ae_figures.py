...
def main() -> int:
    ...
    # Benign NaN reductions (e.g., axis limits over the intentionally
    # missing Xavier F16 cells) emit RuntimeWarnings on some numpy
    # versions; they do not affect the rendered figures.
